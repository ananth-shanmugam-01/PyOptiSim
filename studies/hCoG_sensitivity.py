...
sim_list = {'0.26': '/Users/ananthshanmugam/Desktop/SimResults/hCoG/FSUK_chassis_hCoG_0_26.csv',
            '0.27': '/Users/ananthshanmugam/Desktop/SimResults/hCoG/FSUK_chassis_hCoG_0_27.csv',
            '0.28': '/Users/ananthshanmugam/Desktop/SimResults/hCoG/FSUK_chassis_hCoG_0_28.csv',
            '0.29': '/Users/ananthshanmugam/Desktop/SimResults/hCoG/FSUK_chassis_hCoG_0_29.csv',
            '0.30': '/Users/ananthshanmugam/Desktop/SimResults/hCoG/FSUK_chassis_hCoG_0_3.csv',
            }
...
for sim_name, results_df in results_data.items():
    ...
    hCoG = float(sim_name.replace('FSUK_chassis_hCoG_', '').replace('.csv', ''))
    hCoG_levels.append(hCoG)
    plt.plot(hCoG, laptime, 'o')
plt.plot(hCoG_levels, laptimes, '-')
plt.xlabel('hCoG (m)')
plt.ylabel('Laptime (s)')
plt.title('FSUK LapSim - hCoG Sensitivity')
plt.grid(True)
plt.savefig(os.path.join('/Users/ananthshanmugam/Desktop/SimResults/hCoG/', 'FSUK_hCoG_Sensitivity_Overview.png'), dpi=300)
plt.show()
...
plt.savefig(os.path.join('/Users/ananthshanmugam/Desktop/SimResults/hCoG/', 'FSUK_hCoG_Sensitivity_TimeSeries.png'), dpi=300)
plt.show()