...
sim_list = {    '7.8kWh with 10kW Harvest' : '/Users/ananthshanmugam/Desktop/SimResults/EnergyManagementHarvest_10kW/FSUK_FSUK_EnergyManagement_7_8kWh.csv',
                '5.8kWh with 10kW Harvest' : '/Users/ananthshanmugam/Desktop/SimResults/EnergyManagementHarvest_10kW/FSUK_FSUK_EnergyManagement_5_8kWh.csv',
                '3.8kWh with 10kW Harvest' : '/Users/ananthshanmugam/Desktop/SimResults/EnergyManagementHarvest_10kW/FSUK_FSUK_EnergyManagement_3_8kWh.csv'
            }
...
for sim_name, results_df in results_data.items():
    ...
    axs[3].plot(results_df['sLap'], results_df['power_wheel']/1e3, linestyle='--')
